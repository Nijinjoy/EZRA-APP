...
// import { View, Text, Image, ImageBackground, Pressable, FlatList, Modal } from 'react-native'
...
//                         const bucketName = response.assets[2].type;
//                         const apiUrl = await fetch(`${Api}/api/inference/generatePresignedUrl`);
...
//                         if (res.status) {
//                             console.log('Pre-signed URL:==>', data.data.uploadUrl);
//                         } else {
