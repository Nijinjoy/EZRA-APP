...
const ButtonComponent = (props) => {
    ...
    return (
        <Pressable style={{ borderWidth: 0.5, width: WIDTH * 0.83, height: HEIGHT * 0.072, backgroundColor: background, borderRadius: borderRadius, flexDirection: 'row', justifyContent: "center", alignItems: 'center', borderColor: colors.grey, top: Bottom }} onPress={navigate}>
