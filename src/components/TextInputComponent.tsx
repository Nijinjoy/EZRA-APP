...
const TextInputComponent = ({ icon, placeholder, onChangeText, value, onPress, isTextEnabled = true, containerStyle }) => {
    return (
        <View style={{ borderWidth: 1, borderColor: colors.grey, flexDirection: "row", alignItems: "center", justifyContent: 'center', borderRadius: WIDTH * 0.015 }}>
            <TextInput
                value={value}
