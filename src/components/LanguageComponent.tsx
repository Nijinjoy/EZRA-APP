...
const LanguageComponent = () => {
    return (
        <View style={{ borderWidth: 0, flexDirection: 'row', width: WIDTH * 0.32, padding: HEIGHT * 0.005, borderRadius: WIDTH * 0.015, marginHorizontal: WIDTH * 0.06, backgroundColor: colors.grey }}>
            <Pressable style={{ flexDirection: "row", backgroundColor: colors.lightWhite, padding: WIDTH * 0.01, borderRadius: WIDTH * 0.01 }}>
